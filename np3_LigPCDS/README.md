...
In Step 1, a list of PDB entries from 1.5 to 2.2 Å was retrieved (.pdb and .mtz) from RCSB PDB (https://www.rcsb.org/) in 2020 and their free and organic ligands were filtered and validated (.sdf). It resulted in the list of valid ligands with 244,226 entries. 
...
- Two PDB report tables downloaded in January 2020, located inside the PDB_lists folder:
...
The RCSB PDB lists downloaded for LigPCDS were retrieved in January 2020 and are present in the PDB_lists folder, named as:
...
These report files must follow the table format exported by RCSB PDB in january 2020. 
...
This code was intended to work with RCSB PDB APIs from January 2020. Any updates in RCSB PDB API must be updated in the code.
