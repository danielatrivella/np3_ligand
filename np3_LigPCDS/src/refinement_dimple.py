...
def refine_pdb_entries(db_path, pdb_list_path, num_processors = 2, overwrite_refinement=False, skip_row=0):
	...
	print("**************************************\n")
	if skip_row > 0:
		print(f"- Skipped the first {skip_row} rows of the PDB list.")
	pbar = tqdm(total=n)
	try:
