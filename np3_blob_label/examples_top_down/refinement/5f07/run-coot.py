...
molecule = read_pdb(os.path.join(this_dir, "5f07.pdb"))
set_rotation_centre(-13.51, 6.67, 11.97)
set_zoom(30.)
set_view_quaternion(-0.448337, -0.700881, 0, 0.55476)
refl = os.path.join(this_dir, "5f07.mtz")
